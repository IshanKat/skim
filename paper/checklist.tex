...
\item {\bf Open access to data and code}
    ...
    \item[] Justification: The datasets (NExT-QA, IntentQA) are publicly available and the method is fully specified, but we do not release code with this version.
